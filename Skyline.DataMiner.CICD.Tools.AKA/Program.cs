namespace Skyline.DataMiner.CICD.Tools.AKA
{
    ...
    using Skyline.DataMiner.CICD.Tools.AKA.Commands;

    /// <summary>
    /// dotnet tool to create DataMiner aka short links.
    /// </summary>
    public static class Program
    {
        ...
        {
            var rootCommand = new RootCommand("dotnet tool to create DataMiner aka short links.")
            {
                new CreateCommand()
            };
            ...
            var builder = new CommandLineBuilder(rootCommand).UseDefaults().UseHost(host =>
            {
                host.ConfigureServices(services =>
                    ...
                    {
                        configurationBuilder.AddUserSecrets<CreateCommand>() // For easy testing
